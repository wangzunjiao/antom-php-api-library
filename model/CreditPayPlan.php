...
class CreditPayPlan  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets installmentNum
     *
     * @param int $installmentNum The number of installments. The valid value is from 2 to 12.  More information:  Maximum length: 8 characters
     *
     * @return self
     */
     ...
     * Sets feePercentage
     *
     * @param int|null $feePercentage This field is determined by the sellers' liability. For example, 0 indicates the seller is not liable for any fee. 100 indicates the seller pays 100% of the fee.  Note: Specify this field when the value of creditPayFeeType is PERCENTAGE.  More information:  Value range: 0 - 100
     *
     * @return self
     */
