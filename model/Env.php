...
class Env  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets deviceTokenId
     *
     * @param string|null $deviceTokenId deviceTokenId
     *
     * @return self
     */
     ...
     * Sets colorDepth
     *
     * @param string|null $colorDepth colorDepth
     *
     * @return self
     */
     ...
     * Sets screenHeight
     *
     * @param string|null $screenHeight screenHeight
     *
     * @return self
     */
     ...
     * Sets screenWidth
     *
     * @param string|null $screenWidth screenWidth
     *
     * @return self
     */
     ...
     * Sets timeZoneOffset
     *
     * @param int|null $timeZoneOffset timeZoneOffset
     *
     * @return self
     */
     ...
     * Sets deviceModel
     *
     * @param string|null $deviceModel deviceModel
     *
     * @return self
     */
     ...
     * Sets deviceLanguage
     *
     * @param string|null $deviceLanguage The language of the device where the user places an order.  Note: Specify this parameter if you require risk control. Providing this information helps to identify black-market behavior.    More information:  Maximum length: 32 characters
     *
     * @return self
     */
     ...
     * Sets deviceId
     *
     * @param string|null $deviceId The unique ID of the device the user places an order with.  Note: Specify this parameter if you require risk control. This parameter can be used to build a trusted relationship between users and commonly used devices, thereby reducing risk control interruptions and increasing the payment success rate.    More information:  Maximum length: 64 characters
     *
     * @return self
     */
