...
class Goods  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets goodsQuantity
     *
     * @param string|null $goodsQuantity Quantity of goods.   Note: Specify this parameter if you require risk control. Providing this information helps to increase the accuracy of anti-money laundering and fraud detection, and increase payment success rates.  More information:  Value range: 1 - unlimited
     *
     * @return self
     */
     ...
     * Sets goodsUrl
     *
     * @param string|null $goodsUrl The URL of the website where the user places an order.  Note: Specify this parameter if you require risk control. Providing this information helps to identify black-market behavior.  More information:  Maximum length: 2048 characters
     *
     * @return self
     */
