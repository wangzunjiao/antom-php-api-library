...
class Shipping  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $shippingPhoneNo The phone number of a recipient (including extension).  Specify this parameter when one of the following conditions is met:  You require risk control. The value of paymentMethodType is OVO and you collect the phone number that is bound to the OVO account during the payment process. Providing this information helps to increase the accuracy of anti-money laundering and fraud detection, and increase payment success rates.  More information:  Maximum length: 16 characters
     *
     * @return self
     */
     ...
     * Sets shippingFeeId
     *
     * @param string|null $shippingFeeId shippingFeeId
     *
     * @return self
     */
     ...
     *
     * @param string|null $shippingDescription shippingDescription
     *
     * @return self
     */
