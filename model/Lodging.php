...
class Lodging  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets numberOfNights
     *
     * @param int|null $numberOfNights Number of nights booked by the payer.  More information:  Value range: 1 - unlimited
     *
     * @return self
     */
     ...
     * Sets numberOfRooms
     *
     * @param int|null $numberOfRooms Number of rooms booked by the payer.  More information:  Value range: 1 - unlimited
     *
     * @return self
     */
