...
class BrowserInfo  implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets acceptHeader
     *
     * @param string|null $acceptHeader The accept header of the user's browser.    More information:  Maximum length: 2048 characters
     *
     * @return self
     */
     ...
     * Sets javaEnabled
     *
     * @param bool|null $javaEnabled Indicates whether the user's browser is able to run Java. Valid values are:  true: indicates that the user's browser is able to run Java. false: indicates that the user's browser is unable to run Java. The same applies when the value is empty or you do not specify this parameter.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $javaScriptEnabled Indicates whether the user's browser is able to run Java. Valid values are:  true: indicates that the user's browser is able to run JavaScript. false: indicates that the user's browser is unable to run JavaScript. The same applies when the value is empty or you do not specify this parameter.
     *
     * @return self
     */
     ...
     * Sets language
     *
     * @param string|null $language The language of the user's browser. The value is obtained by using the browser's navigator.language property (as defined in IETF BCP 47).    More information:  Maximum length: 32 characters
     *
     * @return self
     */
     ...
     * Sets userAgent
     *
     * @param string|null $userAgent The user agent of the user's browser.  Specify this parameter when one of the following conditions is met:  You require risk control. The value of paymentMethodType is BLIK and you collect the information of blikCode. Providing this information helps to increase the accuracy of anti-money laundering and fraud detection, and increase payment success rates.    More information:  Maximum length: 2048 characters
     *
     * @return self
     */
