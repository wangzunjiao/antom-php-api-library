 ...
 */
class AlipayPayRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'productCode' => '\request\model\Pay\ProductCodeType',
        'paymentRequestId' => 'string',
        'order' => 'string',
        'paymentAmount' => '\request\model\Pay\Amount',
        'paymentMethod' => '\request\model\Pay\PaymentMethod',
        'paymentExpiryTime' => 'string',
        'paymentRedirectUrl' => 'string',
        'paymentNotifyUrl' => 'string',
        'paymentFactor' => '\request\model\Pay\PaymentFactor',
        'settlementStrategy' => '\request\model\Pay\SettlementStrategy',
        'creditPayPlan' => 'string',
        'appId' => 'string',
        'merchantRegion' => 'string',
        'userRegion' => 'string',
        'env' => '\request\model\Pay\Env',
        'payToMethod' => '\request\model\Pay\PaymentMethod',
        'isAuthorization' => 'bool',
        'merchant' => '\request\model\Pay\Merchant',
        'paymentVerificationData' => '\request\model\Pay\PaymentVerificationData',
        'extendInfo' => 'string',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['paymentExpiryTime'] === null) {
            $invalidProperties[] = "'paymentExpiryTime' can't be null";
        }
        if ($this->container['paymentRedirectUrl'] === null) {
            $invalidProperties[] = "'paymentRedirectUrl' can't be null";
        }
        if ($this->container['paymentNotifyUrl'] === null) {
            $invalidProperties[] = "'paymentNotifyUrl' can't be null";
        }
        ...
        if ($this->container['merchantRegion'] === null) {
            $invalidProperties[] = "'merchantRegion' can't be null";
        }
        if ($this->container['userRegion'] === null) {
            $invalidProperties[] = "'userRegion' can't be null";
        }
        ...
        if ($this->container['isAuthorization'] === null) {
            $invalidProperties[] = "'isAuthorization' can't be null";
        }
        if ($this->container['merchant'] === null) {
            $invalidProperties[] = "'merchant' can't be null";
        }
        if ($this->container['paymentVerificationData'] === null) {
            $invalidProperties[] = "'paymentVerificationData' can't be null";
        }
        if ($this->container['extendInfo'] === null) {
            $invalidProperties[] = "'extendInfo' can't be null";
        }
        if ($this->container['merchantAccountId'] === null) {
            $invalidProperties[] = "'merchantAccountId' can't be null";
        }
        if ($this->container['dualOfflinePayment'] === null) {
            $invalidProperties[] = "'dualOfflinePayment' can't be null";
        }
     ...
     * Gets productCode
     *
     * @return \request\model\Pay\ProductCodeType
     */
     ...
     * Sets productCode
     *
     * @param \request\model\Pay\ProductCodeType $productCode productCode
     *
     * @return self
     */
     ...
     * Gets paymentMethod
     *
     * @return \request\model\Pay\PaymentMethod
     */
     ...
     * Sets paymentMethod
     *
     * @param \request\model\Pay\PaymentMethod $paymentMethod paymentMethod
     *
     * @return self
     */
     ...
     *
     * @param string $paymentExpiryTime paymentExpiryTime
     *
     * @return self
     */
     ...
     *
     * @param string $paymentRedirectUrl paymentRedirectUrl
     *
     * @return self
     */
     ...
     *
     * @param string $paymentNotifyUrl paymentNotifyUrl
     *
     * @return self
     */
     ...
     * Gets paymentFactor
     *
     * @return \request\model\Pay\PaymentFactor|null
     */
     ...
     * Sets paymentFactor
     *
     * @param \request\model\Pay\PaymentFactor|null $paymentFactor paymentFactor
     *
     * @return self
     */
     ...
     *
     * @return \request\model\Pay\SettlementStrategy
     */
     ...
     *
     * @param \request\model\Pay\SettlementStrategy $settlementStrategy settlementStrategy
     *
     * @return self
     */
     ...
     * Sets merchantRegion
     *
     * @param string $merchantRegion merchantRegion
     *
     * @return self
     */
     ...
     * Sets env
     *
     * @param \request\model\Pay\Env $env env
     *
     * @return self
     */
     ...
     * Sets payToMethod
     *
     * @param \request\model\Pay\PaymentMethod $payToMethod payToMethod
     *
     * @return self
     */
     ...
     *
     * @param bool $isAuthorization isAuthorization
     *
     * @return self
     */
     ...
     * Gets merchant
     *
     * @return \request\model\Pay\Merchant
     */
     ...
     * Sets merchant
     *
     * @param \request\model\Pay\Merchant $merchant merchant
     *
     * @return self
     */
     ...
     *
     * @return \request\model\Pay\PaymentVerificationData
     */
     ...
     *
     * @param \request\model\Pay\PaymentVerificationData $paymentVerificationData paymentVerificationData
     *
     * @return self
     */
     ...
     *
     * @param string $merchantAccountId The unique ID to identify a merchant account.  Note: Specify this parameter when you use a single client ID across multiple locations.  More information:  Maximum length: 32 characters
     *
     * @return self
     */
     ...
     *
     * @param bool $dualOfflinePayment dualOfflinePayment
     *
     * @return self
     */
