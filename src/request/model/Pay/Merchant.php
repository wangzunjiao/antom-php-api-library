...
class Merchant implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'merchantAddress' => '\request\model\Pay\Address',
        'merchantRegisterDate' => 'string',
        'store' => '\request\model\Pay\Store',
        'merchantType' => 'string'
    ];
    ...
    */
     ...
     *
     * @return \request\model\Pay\Address
     */
     ...
     *
     * @param \request\model\Pay\Address $merchantAddress merchantAddress
     *
     * @return self
     */
     ...
     * Gets store
     *
     * @return \request\model\Pay\Store
     */
     ...
     * Sets store
     *
     * @param \request\model\Pay\Store $store store
     *
     * @return self
     */
