 ...
 */
class PaymentVerificationData implements ModelInterface, ArrayAccess
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['verifyRequestId'] === null) {
            $invalidProperties[] = "'verifyRequestId' can't be null";
        }
     ...
     *
     * @param string $verifyRequestId verifyRequestId
     *
     * @return self
     */
     ...
     *
     * @param string $authenticationCode authenticationCode
     *
     * @return self
     */
