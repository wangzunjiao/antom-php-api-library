...
class AlipayPayResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'paymentId' => 'string',
        'paymentAmount' => '\request\model\Pay\Amount',
        'paymentData' => 'string',
        'actualPaymentAmount' => '\request\model\Pay\Amount',
        'paymentQuote' => '\request\model\Pay\Quote',
        'paymentTime' => 'string',
        'paymentCreateTime' => 'string',
        'authExpiryTime' => 'string',
        'nonGuaranteeCouponValue' => '\request\model\Pay\Amount',
        'paymentActionForm' => 'string',
        'pspCustomerInfo' => '\request\model\Pay\PspCustomerInfo',
        'challengeActionForm' => '\request\model\Pay\ChallengeActionForm',
        'redirectActionForm' => '\request\model\Pay\RedirectActionForm',
        'orderCodeForm' => 'string',
        'grossSettlementAmount' => '\request\model\Pay\Amount',
        'settlementQuote' => '\request\model\Pay\Quote',
        'extendInfo' => 'string',
        'normalUrl' => 'string',
        'schemeUrl' => 'string',
        'applinkUrl' => 'string',
        'appIdentifier' => 'string',
        'paymentResultInfo' => '\request\model\Pay\PaymentResultInfo',
        'acquirerInfo' => '\request\model\Pay\AcquirerInfo',
        'promotionResult' => '\request\model\Pay\PromotionResult[]',
        'result' => '\request\model\Pay\Result'
    ];
    ...
    */
     ...
     * Gets paymentAmount
     *
     * @return \request\model\Pay\Amount
     */
     ...
     * Sets paymentAmount
     *
     * @param \request\model\Pay\Amount $paymentAmount paymentAmount
     *
     * @return self
     */
     ...
     *
     * @param \request\model\Pay\Amount $actualPaymentAmount actualPaymentAmount
     *
     * @return self
     */
     ...
     * Gets paymentQuote
     *
     * @return \request\model\Pay\Quote
     */
     ...
     * Sets paymentQuote
     *
     * @param \request\model\Pay\Quote $paymentQuote paymentQuote
     *
     * @return self
     */
     ...
     *
     * @param \request\model\Pay\Amount $nonGuaranteeCouponValue nonGuaranteeCouponValue
     *
     * @return self
     */
     ...
     *
     * @return \request\model\Pay\PspCustomerInfo
     */
     ...
     *
     * @param \request\model\Pay\PspCustomerInfo $pspCustomerInfo pspCustomerInfo
     *
     * @return self
     */
     ...
     *
     * @return \request\model\Pay\ChallengeActionForm
     */
     ...
     *
     * @param \request\model\Pay\ChallengeActionForm $challengeActionForm challengeActionForm
     *
     * @return self
     */
     ...
     *
     * @return \request\model\Pay\RedirectActionForm
     */
     ...
     *
     * @param \request\model\Pay\RedirectActionForm $redirectActionForm redirectActionForm
     *
     * @return self
     */
     ...
     *
     * @param \request\model\Pay\Amount $grossSettlementAmount grossSettlementAmount
     *
     * @return self
     */
     ...
     *
     * @param \request\model\Pay\Quote $settlementQuote settlementQuote
     *
     * @return self
     */
     ...
     *
     * @return \request\model\Pay\PaymentResultInfo
     */
     ...
     *
     * @param \request\model\Pay\PaymentResultInfo $paymentResultInfo paymentResultInfo
     *
     * @return self
     */
     ...
     * Gets acquirerInfo
     *
     * @return \request\model\Pay\AcquirerInfo
     */
     ...
     * Sets acquirerInfo
     *
     * @param \request\model\Pay\AcquirerInfo $acquirerInfo acquirerInfo
     *
     * @return self
     */
     ...
     *
     * @return \request\model\Pay\PromotionResult[]
     */
     ...
     *
     * @param \request\model\Pay\PromotionResult[] $promotionResult promotionResult
     *
     * @return self
     */
     ...
     * Gets result
     *
     * @return \request\model\Pay\Result
     */
     ...
     * Sets result
     *
     * @param \request\model\Pay\Result $result result
     *
     * @return self
     */
